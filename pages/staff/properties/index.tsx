  ...
  return (
    <div className="col-md-6 item">
      <div className="transform transition-all duration-300 hover:shadow-xl rounded-xl overflow-hidden bg-white">
        <Link href={`/projects/${_id}`} className="block relative">
          <img
        ...
        <div className="p-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="absolute1 bottom-4 left-4 flex gap-3">
            {!property.whatsapp &&  (
              <a
                href={`https://api.whatsapp.com/send?phone=+96170707627&text=Salam, I want to reserve this project. %0D%0A *${property.title}* %0D%0A *URL:* http://localhost:3000/projects/${property._id} %0D%0A Thank you!`}
                // href={`https://api.whatsapp.com/send?phone=${property.whatsapp}&text=Salam, I want to reserve this product. %0D%0A *${property.title}* %0D%0A *URL:* http://localhost:3000/projects/${property._id} %0D%0A Thank you!`}
                target="_blank"
