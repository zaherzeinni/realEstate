...
const EditBuyguide = () => {
  ...
  const addItem = () => {
    setFormData(prev => ({
      ...prev,
      items: [...prev.items, { id: '', title: '', titlefr: '', desc: '', descfr: '' }],
    }));
  };
                    ...
                    <Grid container spacing={2}>
                      ...
                      <Grid item xs={12} md={6}>
                        ...
                        <Box sx={{ border: '1px solid #ddd', borderRadius: 1, bgcolor: 'background.paper' }}>
                          <ReactQuill
                            value={formData.desc}
                            onChange={(value) => handleDescChange(value, 'desc')}
                            modules={modules}
                            formats={formats}
                            style={{ height: '200px' }}
                          />
                      ...
                      <Grid item xs={12} md={6}>
                        <Typography variant="subtitle2" gutterBottom>Description (French)</Typography>
                        <Box sx={{ border: '1px solid #ddd', borderRadius: 1, bgcolor: 'background.paper' }}>
                          <ReactQuill
                            value={formData.descfr}
                            onChange={(value) => handleDescChange(value, 'descfr')}
                            modules={modules}
                            formats={formats}
                            style={{ height: '200px' }}
                          />
                        ...
                        <Grid container spacing={2}>
                          ...
                          <Grid item xs={12} md={6}>
                            ...
                            <Box sx={{ border: '1px solid #ddd', borderRadius: 1, bgcolor: 'background.paper' }}>
                              <ReactQuill
                                value={item.desc}
                                onChange={(value) => handleDescChange(value, 'desc', index)}
                                modules={modules}
                                formats={formats}
                                style={{ height: '200px' }}
                              />
                          ...
                          <Grid item xs={12} md={6}>
                            ...
                            <Box sx={{ border: '1px solid #ddd', borderRadius: 1, bgcolor: 'background.paper' }}>
                              <ReactQuill
                                value={item.descfr}
                                onChange={(value) => handleDescChange(value, 'descfr', index)}
                                modules={modules}
                                formats={formats}
                                style={{ height: '200px' }}
                              />
