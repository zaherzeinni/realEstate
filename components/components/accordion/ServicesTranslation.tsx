...
export default function ServicesTranslation() {
        ...
        <div className="accordion" id="accordionTravel">
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                {language === "en" ? 
                "1. Why do I need translations for my legal documents?"
                :
                "1.  Pourquoi ai-je besoin de traductions pour mes documents légaux ?"
                }
                <div
            ...
            <AnimateHeight duration={300} height={active === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
                <p>
                  {language === "en" ? "Translations are essential to ensure that your documents are understood and accepted in international transactions." : "Les traductions sont essentielles pour garantir que vos documents sont compris et acceptés dans les transactions internationales."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                           {language === "en" ? 
                "2. What types of legal documents do you translate?"
                :
                "2. Quels types de documents légaux traduisez-vous ?"
                }
                <div
            ...
            <AnimateHeight duration={300} height={active1 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "We translate all relevant documents related to the real estate transaction, including contracts and other necessary legal documents. This ensures that all parties fully understand the terms and conditions of the agreement while complying with local legal requirements." : "Nous traduisons tous les documents pertinents liés à la transaction immobilière, y compris les contrats, et d'autres documents juridiques nécessaires. Cela garantit que toutes les parties comprennent parfaitement les termes et conditions de l'accord, tout en respectant les exigences légales locales."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                ...
                :
                "3. Combien de temps prend la traduction d'un document ?"
                }
                <div
                  className={`ltr:ml-auto1 rtl:mr-auto1 w-auto flex justify-end text-start  absolute end-[15%] xl:end-[12%] 2xl:end-[20%]  ${
            ...
            <AnimateHeight duration={300} height={active2 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "This depends on the length and complexity of the document, but we aim to provide translations within quick turnaround times." : "Cela dépend de la longueur et de la complexité du document, mais nous visons à fournir des traductions dans des délais rapides."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                            {language === "en" ? 
                "4. What are the fees for the translation service?"
                :
                "4. Quels sont les frais pour le service de traduction ?"
                }
                <div
                  className={`ltr:ml-auto1 rtl:mr-auto1 w-auto flex justify-end text-start  absolute end-[15%] xl:end-[12%] 2xl:end-[20%]  ${
            ...
            <AnimateHeight duration={300} height={active3 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "Fees are based on the volume of text to be translated and the type of translation required. A quote will be provided before the service begins." : "Les frais sont basés sur le volume de texte à traduire et le type de traduction requise. Un devis sera fourni avant le service."}
                </p>
              </div>
            </AnimateHeight>
