...
export default function AccordRental() {
  ...
  return (
    <div className="faq-content-wrap mb-48 mt-32   ">
      <div className="faq-content-title mb-20">
        ...
        <h5 className="mt-3 text-primary">{language === "en" ? "Commercial Properties with Rental Income for Sale":"Immobiliers Commerciaux à Revenus Locatifs à Vendre"}</h5>
      </div>
        ...
        <div className="accordion" id="accordionTravel">
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                {language === "en" ? 
                "1. What types of commercial properties are the most profitable ?"
                :
                "1. Quels types de biens immobiliers commerciaux sont les plus rentables ?"
                }
                <div
            ...
            <AnimateHeight duration={300} height={active === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
                <p>
                  {language === "en" ? "Offices, warehouses, and retail spaces in strategic locations are often very profitable." : "Les bureaux, les entrepôts, et les commerces de détail dans des emplacements stratégiques sont souvent très rentables."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                           {language === "en" ? 
                "2. How to evaluate the return on investment for commercial real estate ?"
                :
                "2. Comment évaluer le rendement d'un investissement immobilier commercial ?"
                }
                <div
            ...
            <AnimateHeight duration={300} height={active1 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "Analyze the capitalization rate, net operating income, and operating costs." : "Analysez le taux de capitalisation, le revenu net d'exploitation, et les coûts d'exploitation."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                                {language === "en" ? 
                "3. What are the differences between residential and commercial real estate ?"
                :
                "3. Quelles sont les différences entre l'immobilier résidentiel et commercial ?"
                }
                <div
                  className={`ltr:ml-auto1 rtl:mr-auto1 w-auto flex justify-end text-start  absolute end-[15%] xl:end-[12%] 2xl:end-[20%]  ${
            ...
            <AnimateHeight duration={300} height={active2 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "Commercial real estate tends to offer longer leases and higher returns but may also present more risks." : "L'immobilier commercial tend à offrir des baux plus longs et des rendements plus élevés, mais peut aussi présenter plus de risques."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                            {language === "en" ? 
                "4. What risks are associated with investing in commercial real estate ?"
                :
                "4. Quels sont les risques associés à l'investissement dans l'immobilier commercial ?"
                }
                <div
                  className={`ltr:ml-auto1 rtl:mr-auto1 w-auto flex justify-end text-start  absolute end-[15%] xl:end-[12%] 2xl:end-[20%]  ${
            ...
            <AnimateHeight duration={300} height={active3 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "Risks include vacancy rates, market fluctuations, and high maintenance costs." : "Les risques incluent la vacance locative, les fluctuations du marché, et les coûts d'entretien élevés."}
                </p>
              </div>
            </AnimateHeight>
          </div>
