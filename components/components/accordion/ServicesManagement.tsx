        ...
        <div className="accordion" id="accordionTravel">
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                {language === "en" ? 
                "1. What services do you offer to real estate investors?"
                :
                "1. Quels services offrez-vous aux investisseurs immobiliers ?"
                }
                <div
            ...
            <AnimateHeight duration={300} height={active === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
                <p>
                  {language === "en" ? "We provide specialized services to assist investors in purchasing properties in selected projects or countries, with a comprehensive range of tailored services." : "Nous offrons des services spécialisés pour accompagner les investisseurs dans l'achat de biens dans des projets ou pays sélectionnés, avec une gamme complète de services sur mesure."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                           {language === "en" ? 
                "2. Do you offer solutions for short-term rentals?"
                :
                "2. Proposez-vous des solutions pour les locations à court terme ?"
                }
                <div
            ...
            <AnimateHeight duration={300} height={active1 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "Yes, our experts guide clients towards the best solutions, whether for Airbnb rentals or other short-term accommodations." : "Oui, nos experts guident les clients vers les meilleures solutions, que ce soit pour des locations Airbnb ou d'autres locations courte durée."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            <h6 className="accordion-header111 !border-1 border-b-2 border-gray-500 my-2" id="travelheadingOne">
              ...
              >
                                {language === "en" ? 
                "3. What types of hotel services do you offer?"
                :
                "3. Quels types de services hôteliers proposez-vous ?"
                }
                <div
                  className={`ltr:ml-auto1 rtl:mr-auto1 w-auto flex justify-end text-start  absolute end-[15%] xl:end-[12%] 2xl:end-[20%]  ${
            ...
            <AnimateHeight duration={300} height={active2 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "Some projects include hotel reception services with personalized follow-up, in addition to a full range of property management services." : "Certains projets incluent des services de réception hôtelière avec un suivi personnalisé, en plus d'une palette complète de services de gestion locative."}
                </p>
              </div>
            </AnimateHeight>
          </div>
          ...
          <div className="accordion-item  ">
            ...
            <AnimateHeight duration={300} height={active3 === "1" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px]">
              <p>
                  {language === "en" ? "Our services are designed for both experienced investors and individuals looking to embark on a real estate project." : "Nos services sont conçus pour les investisseurs expérimentés ainsi que pour les particuliers souhaitant se lancer dans un projet immobilier."}
                </p>
              </div>
            </AnimateHeight>
