...
export default function SectionThree({ background }) {
  const rootStyle = ` flex flex-col  pb-24 pt-4 gap-10 sm:gap-0 sm:flex-row items-center sm:items-en justify-cente sm:justify-cente mx-0 sm:mx-[5%] text-NormalWhite    md:h-auto pb-[2vh] px-[3%] sm:px-[1.5%] mt- ssm:mt-16 sm:mt-0 md:mt-0 lg:mt-0   `;
        ...
        <div>
          <div className=" mt-6 !w-full flex-col  flex items-center justify-center">
            <div class="flex items-center">
              ...
              <span class="text-5xl lg:text-8xl 2xl:text-[82px] ml-1 lg:ml-2 !text-gray-800 !font-rubik uppercase text-bc-navy">
                {language === "en" ? "TURN YOUR VISION" : "TRANSFORMEZ VOTRE VISION"}
            ...
            <div class="flex items-center">
              <span class="ml-2 w-[65%] flex items-center gap-1 text-2xl text-primary2 lg:text-4xl 2xl:text-5xl !font-rubik whitespace-nowrap uppercase text-bc-green">
                <img
                  ...
                  alt=""
                />
             {language === "en" ? "INTO REALITY" : "EN RÉALITÉ"} 
...
<div>
<div class="wp-block-uagb-advanced-heading font-[300] !text-xl md:!text-[32px] mt-5  mb-[24px] !text-gray-700">

{language === "en" ? 
<p class="has-text-align-center  !text-gray-700  max-w-[900px] text-center my-6">
From the beginning to the end , you will receive personalized, one-of-a-kind service. We know each of our customers is unique and we embrace it. Let us help you find a property that fits your style and needs. We also offer furniture and design packages to complete your space and make it a home. If you are looking to turn your investment into a rental property, we also offer assistance with property management. We have been in your shoes and we understand what it is like to be an international buyer. We have learned from those experiences and designed a buying process that is incredibly efficient and enjoyable. No matter what your vision is, we are here to help you make it a reality..
</p>
:
<p class="has-text-align-center  !text-gray-700 max-w-[900px] text-center my-6">
Du début jusqu'à la fin, vous bénéficierez d'un service personnalisé et unique en son genre. Nous savons que chacun de nos clients est unique et nous l'assumons. Laissez-nous vous aider à trouver une propriété qui correspond à votre style et à vos besoins. Nous proposons également des forfaits mobilier et design pour compléter votre espace et en faire votre chez-soi. Si vous souhaitez transformer votre investissement en bien locatif, nous proposons également une assistance en matière de gestion immobilière. Nous avons été à votre place et nous comprenons ce que signifie être un acheteur international. Nous avons tiré les leçons de ces expériences et conçu un processus d'achat incroyablement efficace et agréable. Quelle que soit votre vision, nous sommes là pour vous aider à la concrétiser.
</p>
}
<div className=" !mt-14">
    <Link href ='/meet-the-team'>
    
    <span className=" primary-btn1 font-[500] text-2xl !font-rubik text-md text-white rounded-md text-center px-3 py-2 ">
