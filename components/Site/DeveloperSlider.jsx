          ...
          <Swiper {...settings} className="swiper home1-banner-slider ">
            <div className="swiper-wrapper ">
              <SwiperSlide className="swiper-slide ">
                <div
                  className="home1-banner-wrapper  rounded-none"
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(/images/developmentSlider/Aro-interior.jpg)",
                  }}
                >
                    ...
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="home1-banner-content">
                          ...
                          <h1 className="text-[20px] !text-center -ml-4 sm:ml-0 sm:text-4xl lg:text-[40px] font-extrabold">Let's Travel And Explore Destination.</h1>
              ...
              <SwiperSlide className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(/images/developmentSlider/atlantida-featured.jpg)",
                  }}
                >
                  <div className="container">
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="home1-banner-content">
                          ...
                          <h2 className="text-[20px] !text-center -ml-4 sm:ml-0 sm:text-4xl lg:text-[40px] font-extrabold">Let’s Explore Your Holiday Trip.</h2>
                          <p className="w-auto !text-center mx-10 -ml-4 sm:ml-0 text-xs sm:text-[15px]">
              ...
              <SwiperSlide className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(/images/developmentSlider/Beach-Club-View.jpg)",
                  }}
                >
                  <div className="container">
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="home1-banner-content">
                          ...
                          <h2 className="text-[20px] !text-center -ml-4 sm:ml-0 sm:text-4xl lg:text-[40px] font-extrabold">Let's journey and discover a place.</h2>
                          <p className="w-auto !text-center mx-10 -ml-4 sm:ml-0 text-xs sm:text-[15px]">
                            Life is unpredictable, and we understand that plans
                            might change. Enjoy flexible booking options, so you
                            can reschedule or modify your trip with ease.
              ...
              <SwiperSlide className="swiper-slide">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100%), url(/images/developmentSlider/Comercial-Area-Atlantida.jpg)",
                  }}
                >
                  <div className="container">
                    <div className="row">
                      <div className="col-lg-12">
                        <div className="home1-banner-content">
                          ...
                          <h2 className="text-[20px] !text-center -ml-4 sm:ml-0 sm:text-4xl lg:text-[40px] font-extrabold">Let's trek and venture to a spot.</h2>
                          <p className="w-auto !text-center mx-10 -ml-4 sm:ml-0 text-xs sm:text-[15px]">
                            Life is unpredictable, and we understand that plans
                            might change. Enjoy flexible booking options, so you
                            can reschedule or modify your trip with ease.
