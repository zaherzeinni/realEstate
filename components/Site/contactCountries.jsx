...
import ContactCard from "./contactCountriesCard";
  ...
  return (
    <div>
      <div className="text-center">
        ...
        <p className="my-3 text-2xl md:text-3xl !text-primary  font-semibold">{language === "en" ? "Lets talk" : "Contactez-nous"}</p>
      </div>

      <div className="grid  mx-auto container  items-center grid-cols-1 md:grid-cols-3 mt-[33px] space-y-5 md:space-y-0 mb-10">
