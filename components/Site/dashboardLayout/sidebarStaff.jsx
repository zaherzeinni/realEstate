...
const router =useRouter()
  ...
  return (
    <div className="dashboard-sidebar-wrapper overflow-scroll   scroll-m-1">
...
<>
          ...
          <li className="">
            <Link href="/staff/properties">
            <HolidayVillageIcon/>
              <h6>All Properties</h6>
            </Link>
          </li>
          <li className="">
            <Link href="/staff/properties/properties-table">
            <HolidayVillageIcon/>
...
<li className=" cursor-pointer mb-10" onClick={handleLogout}>
